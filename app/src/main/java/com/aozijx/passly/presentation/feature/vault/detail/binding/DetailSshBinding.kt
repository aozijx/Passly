...
internal fun DetailSshBinding(
    ...
    SshKeySection(
        ...
        onFingerprintCopy = { onAction(DetailUiAction.CopyField(FieldKey.USERNAME)) },
        onPassphraseCopy = { onAction(DetailUiAction.CopyField(FieldKey.SSH_PASSPHRASE)) },
        onPassphraseReveal = {
        ...
        onPrivateKeyClick = {
            if (privateKey == null) {
                ...
                onAction(DetailUiAction.CopyField(FieldKey.SSH_KEY))
            }
        },
        onRevealAll = {
            val keys = buildSet {
